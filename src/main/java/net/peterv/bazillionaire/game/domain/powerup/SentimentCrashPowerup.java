...
public class SentimentCrashPowerup extends Powerup {
  private final SentimentCrashTier tier;
  private final Random random;
  private Symbol targetSymbol;

  public SentimentCrashPowerup(SentimentCrashTier tier, Random random) {
    super(0);
    this.tier = tier;
    this.random = random;
  }
