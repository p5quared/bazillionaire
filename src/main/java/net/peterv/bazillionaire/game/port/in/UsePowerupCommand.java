...
public record UsePowerupCommand(String gameId, String playerId, String powerupName, String targetPlayerId,
		int quantity) {
	public UsePowerupCommand(String gameId, String playerId, String powerupName, String targetPlayerId) {
