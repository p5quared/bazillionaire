...
class PlayerCareerStatsServiceTest {
  ...
  void singleGameWithAllStats() {
    ...
    portfolioStatsService.recordPortfolio(username, gameId, 1200_00, 3);
    ...
    assertEquals(1200_00, stats.totalEarningsCents());
    assertEquals(1200_00, stats.bestGameValueCents());
  ...
  void multipleGamesAggregateCorrectly() {
    ...
    portfolioStatsService.recordPortfolio(username, gameId1, 800_00, 2);
    portfolioStatsService.recordPortfolio(username, gameId2, 400_00, 1);
    ...
    assertEquals(1200_00, stats.totalEarningsCents());
    assertEquals(800_00, stats.bestGameValueCents());
  ...
  void missingStatCategoriesStillWork() {
    ...
    assertEquals(0, stats.bestGameValueCents());
  }
}
