...
class SentimentBoostTriggerTest {
  ...
  void awardsNothingWhenProbabilityIs0() {
    var trigger = new SentimentBoostTrigger(0.0, new Random(42));
  ...
  void throwsForInvalidProbability() {
    assertThrows(
        IllegalArgumentException.class, () -> new SentimentBoostTrigger(1.5, new Random()));
  }
}
